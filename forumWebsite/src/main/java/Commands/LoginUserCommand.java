...
public class LoginUserCommand implements Command {
    ...
    /**
     * Used to login the user. Hashes password entered and searches database for
     * same hash, if found it is user password. Otherwise, User login is
     * rejected and sent to error.jsp.
     *
